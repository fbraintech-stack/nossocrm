...
**Acreditando CRM** é uma plataforma completa de gestão de relacionamento com clientes (CRM) que ajuda equipes de vendas a serem mais produtivas e organizadas.

### Por que escolher Acreditando CRM?
...
1. Acesse o repositório: [github.com/fbraintech-stack/nossocrm](https://github.com/fbraintech-stack/nossocrm)
2. Clique no botão **Fork** (canto superior direito)
3. Escolha sua conta pessoal ou organização
4. Aguarde o fork ser criado

> ✅ **Pronto quando**: Você ver o repositório na sua conta do GitHub
...
4. Na lista de repositórios, encontre e selecione **acreditandocrm** (seu fork)
5. Clique em **Deploy**

> ⏱️ **Aguarde**: O deploy leva cerca de 2-3 minutos

6. Quando terminar, você verá uma mensagem de sucesso
7. **Copie a URL** do seu projeto (ex: `https://acreditandocrm-abc123.vercel.app`)
...
2. **Importar repositório**
   - Selecione seu fork do `acreditandocrm`
...
2. **Prepare suas credenciais**
   ...
   **a) Token da Vercel:**
   ...
   - Dê um nome (ex: "Acreditando CRM Installer")
...
O Acreditando CRM tem estas áreas principais:
...
O Acreditando CRM tem dois tipos de usuários:
...
- 🐛 **Problemas**: Abra uma [issue no GitHub](https://github.com/fbraintech-stack/nossocrm/issues)
...
git clone https://github.com/fbraintech-stack/nossocrm.git
cd nossocrm
